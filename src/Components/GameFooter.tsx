...
const GameFooter: React.FC<Props> = ({ openSheet}) =>{
  return (
    ...
    style ={{flexDirection: 'row', marginHorizontal: Scale(10),}}>
      ...
      <View style ={{marginHorizontal: Scale(10)}}>
        <Text style ={{fontSize: Scale(20), fontWeight: 'bold', color: 'black' }}>$100.00</Text>
        <Text style={{fontSize:Scale(14), color: 'black'}}>0 numbers</Text>
      </View>
    </TouchableOpacity>
    <TouchableOpacity
    style ={{
